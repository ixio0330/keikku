export default function Rectangle({ color }: { color: string }) {
  return <svg width="240" height="148" viewBox="0 0 240 148" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M13.2602 10.6153C13.6884 8.23333 15.7611 6.5 18.1813 6.5H223.177C225.66 6.5 227.766 8.32111 228.125 10.7773L233.164 45.2773C233.605 48.2944 231.266 51 228.217 51H11.979C8.86353 51 6.50667 48.1817 7.05792 45.1153L13.2602 10.6153Z" fill={color}/>
    </g>
    <defs>
